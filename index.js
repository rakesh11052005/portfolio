...
var MemStorage = class {
  ...
  async createContactMessage(contactMessageData) {
    ...
    const contactMessage = {
      ...
      newsletter: contactMessageData.newsletter === void 0 ? false : contactMessageData.newsletter,
...
async function registerRoutes(app2) {
  app2.post("/api/contact", async (req, res) => {
    try {
      const validatedData = insertContactMessageSchema.extend({
